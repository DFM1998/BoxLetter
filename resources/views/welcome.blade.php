...
<style>
    ...
    <script>
        ...
        var output = '<div><div style="display: ruby-text;"><i class="fa-regular fa-clock fa-2xl" style="color: #002641"></i></div><div style="display: inline-block;margin-left: 10px;"><p class="timePopup">18:30</p><p class="smallTitle">Pickup time</p></div><hr style="margin-left: -14px; margin-right:-14px;"></div><div style="margin-top:10px;"><div style="display: ruby-text;"><i class="fa-solid fa-map-location-dot fa-2xl" style="color: #002641"></i></div><div style="display: inline-block;margin-left:10px;"><p class="streetPopup" style="line-height: 12px;">120, route de Luxembourg<br>L-3514 Dudelange</p><p class="smallTitle">Street</p></div><hr style="margin-left: -14px; margin-right:-14px;"></div><div style="margin: auto;border: 0;"><button class="directionButton">Direction</button></div>'
    ...
    <aside>
      ...
      <div class="filtersContent">
        <div class="searchField"><div class="searchIcon"><i class="fa-solid fa-magnifying-glass fa-sm"></i></div><input type="text" placeholder=" Search"><div class="pinSearchIconBar"><img src="./images/pin.svg" class="pinSearchIcon"></div></div>
        <hr>
        <p style="display: inline; margin: 20px 0 20px 0;color: #474747;">Emptied yet:</p>
        ...
        <p style="color: #474747;">Time:</p>
        <p style="color: #474747;">Distance:</p>
      </div>

      <p style="text-align: center;font-size: 25px;vertical-align: text-top;"><img style="height: 25px;" src="./images/pin.svg" alt=""> <span id="totalBoxLettersFound">10</span> box letters found</p>
