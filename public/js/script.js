...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#startTime").html(output);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#startTime").change(function () {
    //console.log(this.value);
    var value = this.value;
    var index = horraire.indexOf(value);
    var output = "<option selected disabled>??:??</option>";

    for (var i = index; i < horraire.length; i++) {
      var element = horraire[i];
      output += "<option>" + element + "</option>"; //console.log(element);
    }
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#inputFieldSearch').keyup(function (e) {
    if (e.keyCode == 13) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".searchIcon").click();
    }
  }); // slider that should display the distance 

  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sliderDistance").on("change mousemove", function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#distanceValueDisplay").html(this.value);
  }); // for the mobile version, map only or list only view

  var check = true;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".showMapButton").click(function () {
    if (check) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("main").css("grid-template-columns", "minmax(376px,100%) 0%");
      check = false;
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("main").css("grid-template-columns", "0% minmax(376px,100%)");
      check = true;
    }
  }); // if clicking on a location on the list, open it and display more information

  var checkListLocation = true;
  var firstRun = true;
  var count = 0;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".showListTowns").click(function () {
    if (checkListLocation && firstRun) {
      ...
      firstRun = false;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list_location_all").hide();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".descriptionText").html(" Filter by Town");
      jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON("http://127.0.0.1:8000/api/cities", function (data) {
        //console.log(data);
        var output = "<div class='filterTownDiv'><table style='width: 100%'>";
        ...
        output += "</table></div>";
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filterByTownContent").html(output);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#checkBoxSelectAll").click(function () {
          if (this.checked) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(".townCheckBox").prop("checked", true);
          } else {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(".townCheckBox").prop("checked", false);
          }

          var towns = "";
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(".townCheckBox:checkbox:checked").each(function () {
            //console.log(this.value);
            towns += this.value + ",";
          });
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".townCheckBox").click(function () {
          if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".townCheckBox:checkbox:checked").length >= data.length) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#checkBoxSelectAll").prop("checked", true);
          } else {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#checkBoxSelectAll").prop("checked", false);
          }
      ...
      checkListLocation = false;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list_location_all").hide();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filterByTownContent").show();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".descriptionText").html(" Filter by Town");
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css({
        "background-color": "",
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list_location_all").show();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filterByTownContent").hide();
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON("http://127.0.0.1:8000/api/boxletter/" + city + "", function (data) {
      ...
      for (var i = 0; i < data.length; i++) {
        if (startTime !== undefined) {
          ...
          count++;
          var _element = data[i];
          output += "\n                        <span class=\"list_location_all\" id=\"location_" + _element["idBoxLetter"] + "\">\n                        <div class=\"list_location_close\">\n                            <span class=\"pickupTime\">\n                            Pickup Time<br>\n                            <span class=\"time\">" + _element["pickUpTime"] + "</span>\n                            </span>\n                            <span class=\"pickupAddress\">\n                            Address<br>\n                            <span class=\"address\">" + _element["street"] + " <br>L-" + _element["postal"] + " " + _element["city"] + "</span>\n                            </span>\n                            <span class=\"pickupDistance\">\n                            Distance<br>\n                            <span class=\"distance\">" + calcCrow(_element["normalCoordinates"].split(",")[1], _element["normalCoordinates"].split(",")[0], latitude, longitude).toFixed(2) + " km</span>\n                            </span>\n                        </div>\n                        <div class=\"list_location_open\" hidden>\n                            <table style=\"width: 100%;border-collapse: collapse;\">\n                            <tr style=\"border-bottom: 0.2px solid #9B9B9B\">\n                                <td style=\"text-align:center;width: 25%;\">\n                                    <i class=\"fa-regular fa-clock\" style=\"font-size: 30px\"></i>\n                                </td>\n                                <td>\n                                    <span style=\"font-size: 35px;\">" + _element["pickUpTime"] + "</span>\n                                </td>\n                            </tr>\n                            <tr style=\"border-bottom: 0.2px solid #9B9B9B\">\n                                <td style=\"text-align: center;\">\n                                    <i class=\"fa-solid fa-map-location-dot\" style=\"font-size: 30px\"></i>\n                                </td>\n                                <td>\n                                    <span style=\"font-size: 18px;line-height: 0px;font-family: RajdhaniRegular;\"><p>" + _element["street"] + "</p><p>L-" + _element["postal"] + " " + _element["city"] + "</p></span>\n                                </td>\n                            </tr>\n                            <tr style=\"border-bottom: 0.2px solid #9B9B9B\">\n                                <td style=\"text-align: center;\">\n                                    <i class=\"fa-solid fa-location-arrow\" style=\"font-size: 30px\"></i>\n                                </td>\n                                <td>\n                                    <span>" + calcCrow(_element["normalCoordinates"].split(",")[1], _element["normalCoordinates"].split(",")[0], latitude, longitude).toFixed(2) + " km</span>\n                                </td>\n                            </tr>\n                            <tr>\n                                <td colspan='2' style=\"text-align:center;\">\n                                    <button class=\"directionButton\" style=\"width: 60%; font-size: 20px;margin-top:5px;\" >Direction</button>\n                                </td>\n                            </tr>\n                            </table></div></span>";
        }
      }

      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list_lo").html(output);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#totalBoxLettersFound").html(count); // when clicking on a location display

      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".list_location_all").click(function () {
  ...
  function success(position) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON("https://apiv3.geoportail.lu/geocode/reverse?lon=" + position.coords.longitude + "&lat=" + position.coords.latitude, function (data) {
      //console.log(data["results"][0]);
      var arrayAddress = data["results"][0];
      var output = arrayAddress["number"] + ", " + arrayAddress["street"] + " L-" + arrayAddress["postal_code"] + " " + arrayAddress["locality"];
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#inputFieldSearch").val(output);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".pinSearchIconBar").click(function () {
