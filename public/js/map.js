...
var horraire = ["07:30", "08:00", "08:30", "09:00", "09:30", "10:00", "10:30", "11:00", "11:30", "12:00", "12:30", "13:00", "13:30", "14:00", "14:30", "15:00", "15:30", "16:00", "16:30", "17:00", "17:30", "18:00", "18:30", "19:00"]; // display the map
...
function displayPins(checkOutTowns, startTime, endTime) {
  clearMap(); // get the pins information and display them on the map
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      if (startTime !== undefined) {
        ...
        for (var _i = indexStartTime; _i < indexEndTime; _i++) {
          ...
          if (_element["pickUpTime"] == horraire[_i]) {
...
var position2 = [6.11149, 49.61062]; //var position1 = [98259.62760000027,77052.32989954633];
